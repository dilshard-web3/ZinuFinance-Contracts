...
import "./Interface8/IZombieInuRouter02.sol";
...
contract Presale is Ownable, ReentrancyGuard {
    ...
    function lockLP(uint bnbAmount) internal {
        ...
        IZombieInuRouter02(pcsRouter).addLiquidityETH{value: bnbAmount}(
            presaleData.token,
            tokenAmount,
            0,
            0,
    ...
    function unlockLP() external onlyCreator {
        ...
        address lpToken = IZombieInuFactory(IZombieInuRouter02(pcsRouter).factory()).getPair(presaleData.token, IZombieInuRouter02(pcsRouter).WETH());
