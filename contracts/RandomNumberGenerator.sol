...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
    ...
    address public zinuSwapLottery;
     ...
     * @param _seed: seed provided by the ZinuSwap lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == zinuSwapLottery, "Only ZinuSwapLottery"); 
    ...
    /**
     * @notice Set the address for the ZinuSwapLottery
     * @param _zinuSwapLottery: address of the ZinuSwap lottery
     */
    function setLotteryAddress(address _zinuSwapLottery) external onlyOwner {
        zinuSwapLottery = _zinuSwapLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IZinuSwapLottery(zinuSwapLottery).viewCurrentLotteryId();
    }
}